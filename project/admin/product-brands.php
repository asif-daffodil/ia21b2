...
if ($pageNumber === null) {
    echo "<script>location.href='product-brands.php?page=1'</script>";
}
?>
...
<div class="all-content-wrapper" style="color: white;">
    ...
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="./product-brands.php?page=<?= $pageNumber ?>&editId=<?= $row['id'] ?>" class="btn btn-warning">Edit</a>
                                            <a href="./product-brands.php?page=<?= $pageNumber ?>&deleteId=<?= $row['id'] ?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                            <?php
                                }
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?= $pageNumber != 1 ? null : "disabled" ?>"><a class="page-link" href="./product-brands.php?page=<?= $pageNumber != 1 ? $pageNumber - 1 : 1 ?>">Previous</a></li>
                            <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                                <li class="page-item <?= $i == $pageNumber ? "active" : null ?>"><a class="page-link" href="./product-brands.php?page=<?= $i; ?>"><?= $i ?></a></li>
                            <?php } ?>
                            <li class="page-item <?= $pageNumber != $totalPages ? null : "disabled" ?>"><a class="page-link" href="./product-brands.php?page=<?= $pageNumber != $totalPages ? $pageNumber + 1 : $totalPages ?>">Next</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        if (isset($_POST['editBrand'])) {
            ...
            $result = $conn->query($sql);
            if ($result) {
                echo "<script>toastr.success('Brand updated successfully');setTimeout(()=> location.href='product-brands.php?page=" . $pageNumber . "', 2000)</script>";
            } else {
        ...
        if(isset($_POST['deleteBrand'])){
            ...
            $result = $conn->query($sql);
            if($result){
                echo "<script>toastr.success('Brand deleted successfully');setTimeout(()=> location.href='product-brands.php?page=" . $pageNumber . "', 2000)</script>";
            }else{
        ...
        ?>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <a class="btn btn-success" href="product-brands.php?page=<?= $pageNumber ?>">No</a>
                </div>
            </div>
        <?php }} ?>
    </div>
